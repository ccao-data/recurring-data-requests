...
in `O:\CCAODATA\recurring_data_requests\provisional_ratio_curves\input_data`, labeled using the
...
- Output will show up in `O:\CCAODATA\recurring_data_requests\provisional_ratio_curves\output_data`
